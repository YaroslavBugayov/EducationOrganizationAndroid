...
import com.bugayov.educationorganizationapp.SearchSubjectsResponseSaver
...
@Composable
fun SearchSubject(modifier: Modifier = Modifier, subjectDao: SubjectDao) {
    ...
    Column(modifier = modifier) {
        ...
        SubjectsList(Modifier, subjects, subjectDao, CardButtonState.ADD)
    }
}